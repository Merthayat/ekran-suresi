...
export default function App() {
  ...
  const handleDemoLogin = (role: 'teacher' | 'parent') => {
    ...
    const profile: UserProfile = {
      uid: isTeacherRole ? 'teacher_demo_olcayto' : 'parent_demo_user',
      displayName: isTeacherRole ? 'Olcayto (Öğretmen - Yönetici)' : 'Fatma Yılmaz',
      email: isTeacherRole ? 'olcaytoh@gmail.com' : 'veli.fatma@example.com',
      role: isTeacherRole ? 'teacher' : 'parent',
      userType: isTeacherRole ? 'teacher' : 'parent',
